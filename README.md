...
***UPDATE: If you're experiencing issues with installing Prosodic, consider switching to the [beta of Prosodic 2 in the develop branch here](https://github.com/quadrismegistus/prosodic/tree/develop).***
