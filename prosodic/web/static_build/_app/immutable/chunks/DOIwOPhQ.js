import{c as m,u as b,d as h,r as u,e as w,f as y,g,h as _,i as x,w as n}from"./D74tSO1a.js";function L(e=!1){const t=m,s=t.l.u;if(!s)return;let a=()=>_(t.s);if(e){let i=0,r={};const p=x(()=>{let f=!1;const l=t.s;for(const c in l)l[c]!==r[c]&&(r[c]=l[c],f=!0);return f&&i++,i});a=()=>g(p)}s.b.length&&b(()=>{d(t,a),u(s.b)}),h(()=>{const i=w(()=>s.m.map(y));return()=>{for(const r of i)typeof r=="function"&&r()}}),s.a.length&&h(()=>{d(t,a),u(s.a)})}function d(e,t){if(e.l.s)for(const s of e.l.s)g(s);t()}const T=`From fairest creatures we desire increase,
