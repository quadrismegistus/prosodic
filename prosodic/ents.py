...
class entity:
    ...
    def __getattr__(self, __name: str, **kwargs) -> Any:
        if hasattr(self,'attrs') and __name in self.attrs: return self.attrs[__name]
        if hasattr(self,'parent') and self.parent: return getattr(self.parent, __name)
        return None
    ...
    @cached_property
    def stanzas(self): return self.get_children('Stanza')
    @cached_property
    def lines(self): return self.get_children('Line')
    @cached_property
    def words(self): return self.get_children('Word')

    @cached_property
    def text(self): return self.get_parent('Text')
    @cached_property
    def stanza(self): return self.get_parent('Stanza')
    @cached_property
    def line(self): return self.get_parent('Line')
    @cached_property
    def word(self): return self.get_parent('Word')
